...
func main() {
	...
	// Create some pixels
	pixels := make([]byte, int(winWidth)*int(winHeight)*4)

	// Objects
	player1 := paddle{pos{50, 100}, 20, 100, color{255, 255, 255}, 500, 0}
	player2 := paddle{pos{winWidth - 50, 100}, 20, 100, color{255, 255, 255}, 500, 0}
	ball := ball{pos{300, 300}, 10, 400, 400, color{255, 255, 255}}
	...
	for {
		...
		texture.Update(nil, pixels, int(winWidth)*4)
